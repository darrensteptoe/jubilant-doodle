...
import {
  ...
  OFFICE_CONTEXT_DIMENSION_LABELS,
} from "../core/officeContextLabels.js";
...
export const OFFICE_LEVEL_LABELS = Object.freeze({
  municipal_executive: OFFICE_CONTEXT_CANONICAL_LABELS.municipal_executive,
  municipal_legislative: OFFICE_CONTEXT_CANONICAL_LABELS.municipal_legislative,
  countywide: OFFICE_CONTEXT_CANONICAL_LABELS.countywide,
  state_legislative_lower: OFFICE_CONTEXT_DIMENSION_LABELS.state_legislative_lower,
  state_legislative_upper: OFFICE_CONTEXT_DIMENSION_LABELS.state_legislative_upper,
  congressional_district: OFFICE_CONTEXT_CANONICAL_LABELS.congressional_district,
  statewide_executive: OFFICE_CONTEXT_CANONICAL_LABELS.statewide_executive,
  statewide_federal: OFFICE_CONTEXT_CANONICAL_LABELS.statewide_federal,
  judicial_other: OFFICE_CONTEXT_CANONICAL_LABELS.judicial_other,
  custom_context: OFFICE_CONTEXT_CANONICAL_LABELS.custom_context,
});
