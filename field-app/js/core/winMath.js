...
export function computeAll(input){
  ...
  validation.candidateHistory = {
    ...
    unmatchedCandidateRecordCount: candidateHistory.unmatchedCandidateRecordCount,
    excludedByOfficeCount: candidateHistory.excludedByOfficeCount,
    excludedByElectionTypeCount: candidateHistory.excludedByElectionTypeCount,
