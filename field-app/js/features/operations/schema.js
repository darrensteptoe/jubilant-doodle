...
export const OPERATIONS_STORE_DEFS = {
  persons: {
    keyPath: "id",
    indexes: [
...
export const THIRD_WING_SCHEMA_VERSION = OPERATIONS_SCHEMA_VERSION;
export const THIRD_WING_DB_NAME = OPERATIONS_DB_NAME;
export const THIRD_WING_DB_VERSION = OPERATIONS_DB_VERSION;
export const THIRD_WING_STORES = OPERATIONS_STORES;
export const THIRD_WING_STORE_DEFS = OPERATIONS_STORE_DEFS;
